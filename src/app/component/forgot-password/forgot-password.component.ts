/************************************************************************************************
*  Execution       : 1. default node         cmd> forgotPassword.ts 
*        
*  Purpose         : Goto Forgot Password Link  
* 
*  @file           : forgotPassword.ts
*  @description    : Forgot Password  
*  @module         : forgotPassword.ts - This is optional if expeclictly its an npm or local package
